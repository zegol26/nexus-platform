            ...
            <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex min-w-0 items-center gap-3">
                <Link
                  ...
                  className="min-w-0 truncate rounded-md border border-emerald-200 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:bg-emerald-50"
                >
