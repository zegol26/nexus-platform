    ...
    <NihongoThemeProvider>
      <NihongoThemeShell>
        <div className="flex min-h-screen min-w-0">
          <NihongoSidebar trialMode={isTrialMode} />
          <MobileSidebarDrawer label="Nihongo">
            <NihongoSidebar mobile trialMode={isTrialMode} />
          </MobileSidebarDrawer>
          ...
          <div className="flex min-w-0 max-w-full flex-1 flex-col">
              ...
              <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex min-w-0 items-center gap-3">
                  <Link
                    ...
                    className="min-w-0 truncate rounded-md border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                  >
                ...
                <div className="flex min-w-0 flex-wrap items-center justify-end gap-2 sm:gap-3">
                  <Link
                    href={isTrialMode ? "/checkout" : "/apps/nihongo/curriculum"}
                  ...
                  >
                    {isTrialMode ? "Upgrade" : <LocalizedText id="nav.startLearning" />}
                  </Link>
            ...
            <main className="min-w-0 w-full flex-1 px-4 py-6 sm:px-6 lg:px-10 lg:py-10">
              {children}
            </main>
