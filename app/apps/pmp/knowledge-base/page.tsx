  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <section className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
        <p className="text-sm font-semibold uppercase tracking-[0.24em] text-cyan-300">Knowledge Base</p>
        <h1 className="mt-3 text-3xl font-semibold text-white">Original articles, written for the exam.</h1>
      </section>
