  ...
  const paymentOptions = [
    {
      mode: "production",
      label: "Lanjut bayar",
      description: "Pembayaran resmi production.",
      enabled: isMidtransModeAvailable("production", billingSettings.midtransEnabled),
    },
    {
      mode: "sandbox",
      label: "Lanjut bayar (sandbox)",
      description: "UAT sandbox untuk simulasi pembayaran.",
      enabled: isMidtransModeAvailable("sandbox", billingSettings.midtransEnabled),
    },
  ];
