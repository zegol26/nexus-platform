...
- Validation catches vague prompts, missing answers, duplicate options, unsupported listening answers, missing transcripts, and missing audio references when static audio is configured.
