...
const readingQuestions: AssessmentQuestion[] = [
  {
    ...
    instructionIndonesian: "本文の内容と合っているものはどれですか。 Pilih pernyataan yang sesuai dengan isi teks.",
    options: [
      "ミラさんは朝七時に起きます。",
      "ミラさんは毎晩八時に起きます。",
      "ミラさんは朝ごはんを食べません。",
    ...
    correctAnswer: "ミラさんは朝七時に起きます。",
    explanationIndonesian: "Teks menyebut 「毎朝七時に起きます」, artinya Mira bangun jam tujuh pagi.",
    level: "n5",
    tags: ["reading"],
    passage: {
      japanese:
  ...
  },
  {
    ...
    instructionIndonesian: "本文の内容と合っているものはどれですか。 Pilih pernyataan yang sesuai dengan isi teks.",
    options: [
      "料理は少し高かったですが、とてもおいしかったです。",
      "料理は安かったですが、おいしくなかったです。",
      "田中さんは一人で古いレストランへ行きました。",
      "田中さんはもうその店へ行きたくないです。",
    ],
    correctAnswer: "料理は少し高かったですが、とてもおいしかったです。",
    explanationIndonesian: "Teks menyebut 「少し高かったですが、とてもおいしかった」, artinya agak mahal tetapi sangat enak.",
    level: "n4",
